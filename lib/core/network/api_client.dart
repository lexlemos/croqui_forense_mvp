...
class SessionExpiredException implements Exception {
  @override
  String toString() => 'Sess√£o expirada. Fa√ßa login novamente.';
}

// TODO (Next Sprint): Adicionar Interceptor de Retry com Exponential Backoff (ex: pacote retry) para blindar requisiÁıes contra flutuaÁıes de rede transientes (SocketException, 502).
class AuthInterceptor extends QueuedInterceptor {
  ...
  Future<void> onError(
    ...
    try {
     ...
     final response = await refreshDio.post(
      ...
      debugPrint('[AuthInterceptor] ‚ùå Erro inesperado durante o refresh: $e\n$stackTrace');
      await _forceLogout();
      return handler.reject(
        DioException(
          requestOptions: err.requestOptions,
  ...
  Future<void> _forceLogout() async {
    ...
    debugPrint('[AuthInterceptor] Sess√£o expirada ‚Äî storage limpo.');
  }
}
...
class _ForensicSafeLogInterceptor extends Interceptor {
  ...
  String _loggedPayload(String path, Object? payload) {
    ...
    if (payloadTextLower.contains('senha') ||
      ...
      return '[PAYLOAD SENS√çVEL OMITIDO]';
    }
